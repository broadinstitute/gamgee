...
class Variant {
 public:
  ...
  VariantField<VariantFieldValue<int32_t>> genotype_quals() const;                                            ///< @brief returns a random access object with all the GQ values for all samples contiguously in memory. @warning creates a new object but makes no copies of the underlying values.
  VariantField<VariantFieldValue<int32_t>> phred_likelihoods() const;                                         ///< @brief returns a random access object with all the PL values for all samples contiguous in memory. @warning creates a new object but makes no copies of the underlying values.
  VariantField<Genotype> genotypes() const;                                                                   ///< @brief returns a random access object with all the values in a given GT tag for all samples contiguous in memory. @warning Only int8_t GT fields have been tested. @warning Missing GT fields are untested. @warning creates a new object but makes no copies of the underlying values.

  // generic individual field getters (a.k.a "format fields")
  VariantField<VariantFieldValue<int32_t>> integer_individual_field(const std::string& tag) const;            ///< @brief returns a random access object with all the values in a give individual field tag in integer format for all samples contiguous in memory.  @warning Only int8_t GT fields have been tested. @warning Missing GT fields are untested. @warning creates a new object but makes no copies of the underlying values.
  VariantField<VariantFieldValue<float>> float_individual_field(const std::string& tag) const;                ///< @brief returns a random access object with all the values in a give individual field tag in float format for all samples contiguous in memory.  @warning Only int8_t GT fields have been tested. @warning Missing GT fields are untested. @warning creates a new object but makes no copies of the underlying values.
  VariantField<VariantFieldValue<std::string>> string_individual_field(const std::string& tag) const;         ///< @brief returns a random access object with all the values in a give individual field tag in string format for all samples contiguous in memory. @warning Only int8_t GT fields have been tested. @warning Missing GT fields are untested. @warning creates a new object but makes no copies of the underlying values.

  // generic shared field getters (a.k.a "info fields")
  std::vector<int32_t> integer_shared_field(const std::string& tag) const;                                    ///< @brief returns a random access object with all the values in a given shared field tag in integer format for all samples contiguous in memory. @warning creates a new vector and copies all underlying values (converting if necessary) to the new vector.
  std::vector<float> float_shared_field(const std::string& tag) const;                                        ///< @brief returns a random access object with all the values in a given shared field tag in float format for all samples contiguous in memory. @warning creates a new vector and copies all underlying values (converting if necessary) to the new vector.
  std::vector<std::string> string_shared_field(const std::string& tag) const;                                 ///< @brief returns a random access object with all the values in a given shared field tag in string format for all samples contiguous in memory. @warning creates a new vector and copies all underlying values (converting if necessary) to the new vector.
  std::vector<bool> boolean_shared_field(const std::string& tag) const;                                       ///< @brief returns a random access object with all the values in a given shared field tag in boolean format for all samples contiguous in memory. @warning creates a new vector and copies all underlying values (converting if necessary) to the new vector.
